...
nextBtn.addEventListener(
  ...
  (displayNext = () => {
    ...
    if (questionCount == quizArray.length) {
      ...
      //user score
      // userScore.innerHTML = nama + ' score is ' + scoreCount + ' out of ' + questionCount;
      //Redirect to result.html
      // window.location.href = 'result.html';
      var parameter1 = 'nilai1';
      var parameter2 = 'nilai2';

      var url = 'result.html' + '?param1=' + encodeURIComponent(parameter1) + '&param2=' + encodeURIComponent(parameter2);
